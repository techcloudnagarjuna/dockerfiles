 ...
 * @ignore
 */
define(['exports', 'ojs/ojcore-base', 'ojs/ojdomutils', 'ojs/ojvcomponent-element', 'ojs/ojtranslation', 'ojs/ojfilepickerutils'], function (exports, oj, DomUtils, ojvcomponentElement, Translations, ojfilepickerutils) { 'use strict';
    ...
    exports.FilePicker = class FilePicker extends ojvcomponentElement.ElementVComponent {
        constructor(props) {
            super(props);
        ...
        _renderDisabled(props, triggerSlot) {
            ...
            return (ojvcomponentElement.h("oj-file-picker", { class: rootClasses },
                ojvcomponentElement.h("div", { class: 'oj-filepicker-disabled oj-filepicker-container' }, triggerSlot || this._renderDefaultTriggerContent(props))));
        }
        _renderWithCustomTrigger(props, triggerSlot, clickHandler) {
            const dndHandlers = this._getDndHandlers(props);
            return (ojvcomponentElement.h("oj-file-picker", { class: 'oj-filepicker' + this._getFocusClass(), ref: this.rootElemRef, onFocusin: this._handleFocusIn, onFocusout: this._handleFocusOut },
        ...
        _renderWithDefaultTrigger(props, clickHandler) {
            ...
            const dndHandlers = this._getDndHandlers(props);
            return (ojvcomponentElement.h("oj-file-picker", { class: 'oj-filepicker oj-filepicker-no-trigger', ref: this.rootElemRef },
                ojvcomponentElement.h("div", { onClick: clickHandler, onKeypress: this._handleSelectingFiles, class: 'oj-filepicker-container' },
        ...
        _renderDefaultTriggerContent(props) {
            ...
            return [
                ojvcomponentElement.h("div", null,
                    ojvcomponentElement.h("div", { class: 'oj-filepicker-text' }, primaryText),
                    ojvcomponentElement.h("div", { class: 'oj-filepicker-secondary-text' }, secondaryText)),
                ojvcomponentElement.h("div", { class: 'oj-filepicker-icon oj-fwk-icon-plus oj-fwk-icon' })
            ];
        }
    ...
    exports.FilePicker = __decorate([
        ojvcomponentElement.customElement('oj-file-picker')
    ], exports.FilePicker);
