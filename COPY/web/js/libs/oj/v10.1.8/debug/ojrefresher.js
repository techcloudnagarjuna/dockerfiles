 ...
 * @ignore
 */
define(['touchr', 'ojs/ojcore-base', 'jquery', 'ojs/ojcontext', 'ojs/ojpulltorefresh', 'ojs/ojlogger'], function (touchr, oj, $, Context, ojpulltorefresh, ojlogger) { 'use strict';
    ...
    oj.__registerWidget('oj.ojRefresher', $.oj.baseComponent,
      {
        ...
        _setupPullToRefresh: function () {
          ...
          ojpulltorefresh.setupPullToRefresh(this.scrollerElement,
