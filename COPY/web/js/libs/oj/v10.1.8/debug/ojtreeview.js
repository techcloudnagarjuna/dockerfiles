       ...
       */
        ...
        */
        ...
        _handleKeyDown: function (event) {
          ...
          } else if (keyCode === 65 && DomUtils.isMetaKeyPressed(event)
        ...
        */
        ...
        _getOptionDefaults: function () {
          if (this.defaultOptions == null) {
            this.defaultOptions =
              ojthemeutils.parseJSONFromFontFamily(this._getOptionDefaultsStyleClass());
          }
