 ...
 * @ignore
 */
define(['exports', 'ojs/ojkoshared'], function (exports, BindingProviderImpl) {
  'use strict';
  ...
  var BindingProvider = function BindingProvider() {};
  /**
  ...
  var registerPreprocessor = BindingProvider.registerPreprocessor;
  var createBindingExpressionEvaluator = BindingProvider.createBindingExpressionEvaluator;
