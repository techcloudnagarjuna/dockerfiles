 ...
 * @ignore
 */
define(['ojs/ojcore-base', 'jquery', 'ojs/ojcomponentcore'], function (oj, $, Components) {
  'use strict';
  ...
  DataCollectionEditUtils.basicHandleEditEnd = function (event, ui) {
    ...
    var input = $(ui.cellContext.parentElement).find('.oj-component-initnode')[0]; // For upstream or indirect dependency we will still rely components being registered on the oj namespace.
