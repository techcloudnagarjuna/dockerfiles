...
define(['exports', 'ojs/ojcore-base', 'ojs/ojcomponentcore', 'jquery', 'ojs/ojlabel', 'ojs/ojthemeutils', 'ojs/ojcontext', 'ojs/ojlogger', 'ojs/ojvalidator-required', 'ojs/ojlabelledbyutils', 'ojs/ojtranslation', 'ojs/ojmessaging', 'ojs/ojconverterutils', 'ojs/ojvalidation-error', 'ojs/ojpopup', 'hammerjs', 'ojs/ojjquery-hammer', 'ojs/ojdomutils', 'ojs/ojanimation', 'ojs/ojfocusutils'], function (exports, oj, Components, $, ojlabel, ojthemeutils, Context, Logger, RequiredValidator, LabelledByUtils, Translations, Message, ConverterUtils, ojvalidationError, ojpopup, Hammer, ojjqueryHammer, DomUtils, AnimationUtils, FocusUtils) {
  ...
  */
  ...
  oj.__registerWidget('oj.editableValue', $.oj.baseComponent, {
    ...
    _SetupResources: function _SetupResources() {
      this._super(); // Since initComponentMessaging gets called during component creation, and that activates
      ...
      if (this._IsCustomElement() && this._hammerIsUnregistered) {
        var messaging = this._getComponentMessaging();
  ...
  PopupMessagingStrategy.prototype._registerLauncherEvents = function () {
    ...
    var events = this._getPopupEventNamesToRegisterForComp(); // 1. associate the ojPopup component to wrapper <div> for popup content
    ...
    if (events.open) {
      ...
      var needsPressEvent = this._needsPressEvent(events);

      nonPressOpenEvents = this._getNamespacedEvents(events.open.replace('press', ''), PopupMessagingStrategy._OPEN_NAMESPACE);
      jqLauncher.on(nonPressOpenEvents, this._openPopupCallback); // The pressHold gesture also fires a contextmenu event on Windows 10 touch.
  ...
  PopupMessagingStrategy.prototype.setupResources = function () {
    var events = this._getPopupEventNamesToRegisterForComp();
  ...
  */
  ...
  PopupMessagingStrategy.prototype._getPopupEventNamesToRegisterForComp = function () {
    var compDefaults = PopupMessagingStrategy._DEFAULTS_BY_COMPONENT[this.GetComponent().widgetName];

    return compDefaults ? compDefaults.events : PopupMessagingStrategy._DEFAULTS_BY_COMPONENT.default.events;
  };
  /**
