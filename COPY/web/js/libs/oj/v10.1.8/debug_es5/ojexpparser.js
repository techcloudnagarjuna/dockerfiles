...
define(['exports'], function (exports) {
  ...
  var ExpParser = function ExpParser() {
    // Parsing
    // -------
    ...
    function _gobbleVariable(context, stopAtType) {
      ...
      while (ch_i === PERIOD_CODE || ch_i === OBRACK_CODE || ch_i === OPAREN_CODE || _isOptionalChaining(context)) {
        context.index++;
    ...
    */
    ...
    function _isOptionalChaining(context) {
      ...
      if (expr.charCodeAt(context.index) === QUMARK_CODE && expr.charCodeAt(context.index + 1) === PERIOD_CODE && !_isDecimalDigit(expr.charCodeAt(context.index + 2))) {
        return true;
      }
