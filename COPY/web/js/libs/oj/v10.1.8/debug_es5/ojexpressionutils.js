 ...
 * @ignore
 */
define(['exports', 'ojs/ojconfig', 'ojs/ojcustomelement-utils'], function (exports, Config, ojcustomelementUtils) {
  'use strict';
  /**
   * @license
  ...
  var ExpressionUtils = function ExpressionUtils() {};
  /**
  ...
  var getExpressionInfo = ExpressionUtils.getExpressionInfo;
  var createGenericExpressionEvaluator = ExpressionUtils.createGenericExpressionEvaluator;
