...
define(['exports', 'ojs/ojcore-base'], function (exports, oj) {
  ...
  var teardownInput = function teardownInput() {
    if (isIOS) document.body.removeChild(input);
    input = null;
  };

  var setupInput = function setupInput(fileOptions) {
    if (input) teardownInput();
    ...
    if (isIOS) document.body.appendChild(input);
  };
