 ...
 * @ignore
 */
define(['exports', 'ojs/ojcore-base', 'ojs/ojthemeutils'], function (exports, oj, ThemeUtils) {
  'use strict';
  ...
  GanttUtils.computeTableColumnHeaderHeight = function (table, gantt, axisInfo) {
    ...
    totalHeight += getAxisHeight(minorAxis, 'minor'); // todo: investigate offset required for IE/Edge
  ...
  GanttUtils._getDefaultTimeAxisHeight = function (gantt, type) {
    ...
    dummyParent.className = dummyParent.className + GANTT_CLASS + ' ' + DVT_BASE_CLASS; // Determine axis label and axis height
  ...
  var computeTableColumnHeaderHeight = GanttUtils.computeTableColumnHeaderHeight;
  exports.computeTableColumnHeaderHeight = computeTableColumnHeaderHeight;
