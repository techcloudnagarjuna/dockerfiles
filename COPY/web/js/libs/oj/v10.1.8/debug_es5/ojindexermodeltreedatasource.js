 ...
 * @ignore
 */
define(['exports', 'ojs/ojcore-base', 'ojs/ojindexer', 'ojs/ojdatasource-common'], function (exports, oj, ojindexer, ojdatasourceCommon) {
  'use strict';
  ...
  var IndexerModelTreeDataSource = function IndexerModelTreeDataSource(data, idAttribute, listener, options) {
    this.data = data;
  ...
  oj._registerLegacyNamespaceProp('IndexerModelTreeDataSource', IndexerModelTreeDataSource); // Subclass from TreeDataSource
  ...
  IndexerModelTreeDataSource.prototype.fetchChildren = function ( // eslint-disable-next-line no-unused-vars
  ...
  exports.IndexerModelTreeDataSource = IndexerModelTreeDataSource;
