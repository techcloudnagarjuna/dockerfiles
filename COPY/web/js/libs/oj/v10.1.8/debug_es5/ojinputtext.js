...
define(['ojs/ojcore', 'jquery', 'ojs/ojthemeutils', 'ojs/ojeditablevalue', 'ojs/ojcore-base', 'ojs/ojdomutils', 'ojs/ojfilter-length', 'ojs/ojvalidator-regexp', 'ojs/ojcustomelement-utils'], function (ojcore, $, ojthemeutils, ojeditablevalue, oj, DomUtils, LengthFilter, RegExpValidator, ojcustomelementUtils) {
  ...
  oj.__registerWidget('oj.inputBase', $.oj.editableValue, {
    ...
    _ComponentCreate: function _ComponentCreate() {
      ...
      this._rtl = this._GetReadingDirection() === 'rtl'; // JET-39086 - raw-value is not getting updated until space in android devices
      // In android device we need to update rawValue even for composition events
      // Get and store agent info

      this._isAndroidDevice = oj.AgentUtils.getAgentInfo().os === oj.AgentUtils.OS.ANDROID; // update element state using options
