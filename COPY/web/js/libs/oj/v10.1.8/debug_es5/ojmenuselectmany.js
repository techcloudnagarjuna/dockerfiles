 ...
 * @ignore
 */
define(['ojs/ojcomponentcore', 'ojs/ojoption', 'ojs/ojdataprovider', 'ojs/ojcomposite'], function (ojcomponentcore, ojoption, ojdataprovider, Composite) {
  'use strict';
  /**
   * @license
  ...
  MenuSelectManyViewModel.prototype._propertyChanged = function (detail) {
    if (detail.updatedFrom === 'external' && detail.property === 'value' || detail.updatedFrom === 'external' && detail.property === 'disabled' || detail.updatedFrom === 'external' && detail.property === 'options') {
  ...
  MenuSelectManyViewModel.prototype._handleOptionMutations = function () {
    ...
    for (var i = 0; i < children.length; i++) {
      var option = children[i]; // seperators don't have the oj-menu-item selector
