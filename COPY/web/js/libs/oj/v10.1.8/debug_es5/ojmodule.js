 ...
 * @ignore
 */
define(['ojs/ojcore-base', 'knockout', 'ojs/ojlogger', 'ojs/ojcontext'], function (oj, ko, Logger, Context) {
  'use strict';
  ...
  var ModuleBinding = {}; // Define a mapping variable that maps the return value of the module to the name used in the callback function of a require call.
          ...
          if (modelPromise == null) {
            ...
            if (viewPromise == null) {
              if (viewName != null) {
                ...
                viewPromise = _getOjModuleRequirePromise(requireFunc, 'view', viewPath + viewName + ModuleBinding.defaults.viewSuffix);
              } else {
                resolveBusyState();
