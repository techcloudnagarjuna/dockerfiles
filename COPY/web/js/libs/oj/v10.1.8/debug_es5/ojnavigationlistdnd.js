 ...
 * @ignore
 */
define(['exports', 'jquery', 'ojs/ojcore-base', 'ojs/ojlistviewdnd'], function (exports, $, oj, ojlistviewdnd) {
  'use strict';
  ...
  var NavigationListDndContext = function NavigationListDndContext(navlist) {
    NavigationListDndContext.superclass.constructor.call(this, navlist);
  };

  oj._registerLegacyNamespaceProp('NavigationListDndContext', NavigationListDndContext); // Subclass from ListViewDndContext


  oj.Object.createSubclass(NavigationListDndContext, oj.ListViewDndContext, 'oj.NavigationListDndContext');
  /**
  ...
  NavigationListDndContext.prototype.GetDragImageWidth = function (item) {
    ...
    return edge === 'top' || edge === 'bottom' ? item.offsetWidth : oj.NavigationListDndContext.superclass.GetDragImageWidth.call(this, item);
  };
  /**
  ...
  */
  ...
  NavigationListDndContext.prototype.SetDragItemImage = function (nativeEvent, items) {
    ...
    dragImage.addClass(this.GetDragImageClass()).css({
  ...
  NavigationListDndContext.prototype.GetCutItems = function (event) {
    var items = [];
    items.push(this.m_contextMenuItem && this.m_contextMenuItem.length > 0 ? this.m_contextMenuItem[0] : this._getActiveItem());
    return items;
  };
