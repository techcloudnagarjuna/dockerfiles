...
define(['ojs/ojinputtext', 'ojs/ojjquery-hammer', 'ojs/ojpagingmodel', 'ojs/ojvalidation-number', 'ojs/ojcore-base', 'jquery', 'ojs/ojdomutils', 'ojs/ojcontext', 'hammerjs', 'ojs/ojlogger', 'ojs/ojconverter-number'], function (ojinputtext, ojjqueryHammer, ojpagingmodel, ojvalidationNumber, oj, $, DomUtils, Context, hammerjs, ojlogger, ojconverterNumber) {
  ...
  (function () {
    ...
    oj.CustomElementBridge.register('oj-paging-control', {
      metadata: __oj_paging_control_metadata
    });
  })();
  /**
   * @license
  ...
  (function () {
    oj.__registerWidget('oj.ojPagingControl', $.oj.baseComponent, {
      ...
      previousPage: function previousPage() {
        ...
        if (data != null) {
          var page = this._getCurrentPage(); // can only go to previous page if on 2nd page or greater
      ...
      nextPage: function nextPage() {
        ...
        if (data != null) {
          ...
          if (this._isTotalSizeConfidenceActual() && page + 1 <= this._getTotalPages() - 1 || this._getTotalPages() < 0 || !this._isTotalSizeConfidenceActual()) {
            return this._invokeUserDataPageFetch(page + 1);
          }
        }
      ...
      page: function page(_page) {
        ...
        if (data != null) {
          if (this._isTotalSizeConfidenceActual() && _page <= this._getTotalPages() - 1 || this._getTotalPages() < 0 || !this._isTotalSizeConfidenceActual()) {
            return this._invokeUserDataPageFetch(_page);
          }
        }
      ...
      _ReleaseResources: function _ReleaseResources() {
        this._super(); // unregister the listeners on the datasource
        ...
        this._unregisterSwipeHandler(); // Remove any pending busy states
      ...
      _addComponentBusyState: function _addComponentBusyState(msg) {
        ...
        var resolver = busyContext.addBusyState(options); // Keep track of the busy state resolvers so that we can clean up later
       ...
       * @private
       */
      _removeComponentBusyState: function _removeComponentBusyState(resolver) {
        // Remove the busy state resolver from tracking
        if (this._busyStateResolvers) {
          var index = this._busyStateResolvers.indexOf(resolver);

          if (index >= 0) {
            this._busyStateResolvers.splice(index, 1); // Resolve the busy state only if it's found in the tracking list
      ...
      _draw: function _draw() {
        var options = this.options; // add main css class to element
      ...
      _events: {
         ...
         */
        'mouseup .oj-pagingcontrol-loadmore-link': function mouseupOjPagingcontrolLoadmoreLink(event) {
          this.loadNext(); // we need to listen to mouseup because click is not
          // reliable on MacOS X
         ...
         * invoke loading next page of data
         */
        'click .oj-pagingcontrol-loadmore-link': function clickOjPagingcontrolLoadmoreLink(event) {
         ...
         */
        'click .oj-pagingcontrol-nav-dot': function clickOjPagingcontrolNavDot(event) {
         ...
         * invoke loading page of data
         */
        'click .oj-pagingcontrol-nav-page': function clickOjPagingcontrolNavPage(event) {
          if (!$(event.currentTarget).hasClass(this._MARKER_STYLE_CLASSES._DISABLED)) {
            var pageNum = $(event.currentTarget).attr('data-oj-pagenum');
            this.page(pageNum);
          }
         ...
         */
        'click .oj-pagingcontrol-nav-first': function clickOjPagingcontrolNavFirst(event) {
          if (!$(event.currentTarget).hasClass(this._MARKER_STYLE_CLASSES._DISABLED)) {
            this.firstPage();
          }
         ...
         */
        'click .oj-pagingcontrol-nav-previous': function clickOjPagingcontrolNavPrevious(event) {
          if (!$(event.currentTarget).hasClass(this._MARKER_STYLE_CLASSES._DISABLED)) {
            this.previousPage();
          }
         ...
         * invoke loading next page of data
         */
        'click .oj-pagingcontrol-nav-next': function clickOjPagingcontrolNavNext(event) {
          if (!$(event.currentTarget).hasClass(this._MARKER_STYLE_CLASSES._DISABLED)) {
            this.nextPage();
          }
         ...
         */
        'click .oj-pagingcontrol-nav-last': function clickOjPagingcontrolNavLast(event) {
          if (!$(event.currentTarget).hasClass(this._MARKER_STYLE_CLASSES._DISABLED)) {
            this.lastPage();
          }
         ...
         */
        'keypress .oj-pagingcontrol-nav-input': function keypressOjPagingcontrolNavInput(event) {
         ...
         * Add oj-active
         */
        'mousedown .oj-pagingcontrol-nav-first': function mousedownOjPagingcontrolNavFirst(event) {
          if (!$(event.currentTarget).hasClass(this._MARKER_STYLE_CLASSES._DISABLED)) {
         ...
         * Add oj-active
         */
        'mousedown .oj-pagingcontrol-nav-previous': function mousedownOjPagingcontrolNavPrevious(event) {
          if (!$(event.currentTarget).hasClass(this._MARKER_STYLE_CLASSES._DISABLED)) {
            $(event.target).addClass(this._MARKER_STYLE_CLASSES._ACTIVE);
          }
         ...
         * Add oj-active
         */
        'mousedown .oj-pagingcontrol-nav-next': function mousedownOjPagingcontrolNavNext(event) {
          if (!$(event.currentTarget).hasClass(this._MARKER_STYLE_CLASSES._DISABLED)) {
            $(event.target).addClass(this._MARKER_STYLE_CLASSES._ACTIVE);
          }
         ...
         * Add oj-active
         */
        'mousedown .oj-pagingcontrol-nav-last': function mousedownOjPagingcontrolNavLast(event) {
          if (!$(event.currentTarget).hasClass(this._MARKER_STYLE_CLASSES._DISABLED)) {
            $(event.target).addClass(this._MARKER_STYLE_CLASSES._ACTIVE);
          }
         ...
         * Remove oj-active
         */
        'mouseup .oj-pagingcontrol-nav-first': function mouseupOjPagingcontrolNavFirst(event) {
         ...
         * Remove oj-active
         */
        'mouseup .oj-pagingcontrol-nav-previous': function mouseupOjPagingcontrolNavPrevious(event) {
          $(event.target).removeClass(this._MARKER_STYLE_CLASSES._ACTIVE);
          event.preventDefault();
        },
         ...
         * Remove oj-active
         */
        'mouseup .oj-pagingcontrol-nav-next': function mouseupOjPagingcontrolNavNext(event) {
          $(event.target).removeClass(this._MARKER_STYLE_CLASSES._ACTIVE);
          event.preventDefault();
        },
         ...
         * Remove oj-active
         */
        'mouseup .oj-pagingcontrol-nav-last': function mouseupOjPagingcontrolNavLast(event) {
          $(event.target).removeClass(this._MARKER_STYLE_CLASSES._ACTIVE);
          event.preventDefault();
        },
         ...
         * Remove oj-active
         */
        'mouseleave .oj-pagingcontrol-nav-first': function mouseleaveOjPagingcontrolNavFirst(event) {
          $(event.target).removeClass(this._MARKER_STYLE_CLASSES._ACTIVE);
          event.preventDefault();
        },
         ...
         * Remove oj-active
         */
        'mouseleave .oj-pagingcontrol-nav-previous': function mouseleaveOjPagingcontrolNavPrevious(event) {
          $(event.target).removeClass(this._MARKER_STYLE_CLASSES._ACTIVE);
          event.preventDefault();
        },
         ...
         * Remove oj-active
         */
        'mouseleave .oj-pagingcontrol-nav-next': function mouseleaveOjPagingcontrolNavNext(event) {
          $(event.target).removeClass(this._MARKER_STYLE_CLASSES._ACTIVE);
          event.preventDefault();
        },
         ...
         * Remove oj-active
         */
        'mouseleave .oj-pagingcontrol-nav-last': function mouseleaveOjPagingcontrolNavLast(event) {
          $(event.target).removeClass(this._MARKER_STYLE_CLASSES._ACTIVE);
          event.preventDefault();
        }
      },
       ...
       * @private
       */
      _clearCachedDomLoadMore: function _clearCachedDomLoadMore() {
       ...
       * @private
       */
      _clearCachedDomPagingControlNav: function _clearCachedDomPagingControlNav() {
       ...
       * @private
       */
      _createNavArrow: function _createNavArrow(typeClass, iconClass, tipKey, accLabelKey, accLabelClass, isVertical) {
        var navArrow = $(document.createElement('a')); // JAWS on Firefox does not read aria-disabled state on links, even
        ...
        navArrow.addClass(this._MARKER_STYLE_CLASSES._DISABLED); // Use aria-disabled to specify the disabled state because there is
        ...
        var accLabelText = this.getTranslatedString(accLabelKey); // Add an aria-label on the button.  Otherwise screen reader will
       ...
       * @private
       */
      _disableNavArrow: function _disableNavArrow(navArrow, disable) {
        if (disable) {
      ...
      _getData: function _getData() {
        if (!this._data && this.options.data != null) {
          ...
          this._dataMetadata = this.options.data; // In case we get a delayed setting of the data property--check to rebind the listeners
       ...
       * @private
       */
      _getItemRange: function _getItemRange(size, startIndex) {
        ...
        var pageTo; // If the single line translations exist, use those
        ...
        if (this.getTranslatedString(this._BUNDLE_KEY._MSG_ITEM_RANGE_NO_TOTAL, {
          ...
          if (data != null && data.totalSize() != null && size != null) {
            ...
            if (data.totalSize() !== -1) {
              ...
              itemRangeCurrentText = this.getTranslatedString(this._BUNDLE_KEY._MSG_ITEM_RANGE_NO_TOTAL, {
                pageFrom: pageFrom,
                pageTo: pageTo
              });
            }
          ...
          itemRangeCurrentText = this.getTranslatedString(this._BUNDLE_KEY._MSG_ITEM_RANGE_CURRENT_SINGLE, {
            pageFrom: pageFrom
          });
          pageTo = parseInt(startIndex, 10) + parseInt(size, 10);
          pageFrom = pageTo > 0 ? pageFrom + 1 : 0;
          ...
          if (data.totalSize() !== -1) {
            ...
            if (pageFrom === pageTo) {
              ...
              itemRangeCurrentText = this.getTranslatedString(this._BUNDLE_KEY._MSG_ITEM_RANGE_CURRENT, {
                pageFrom: pageFrom,
                pageTo: pageTo
              });
            }
       ...
       * @private
       */
      _getMaxPageLinks: function _getMaxPageLinks() {
       ...
       * @private
       */
      _getMaxPageVal: function _getMaxPageVal(size) {
        var maxPageVal = 0;
        ...
        if (this._getTotalPages() > 0 && this._isTotalSizeConfidenceActual()) {
          ...
          if (data != null && (data.totalSizeConfidence() === 'atLeast' || data.totalSizeConfidence() === 'estimate')) {
       ...
       * @private
       */
      _getRejectPromise: function _getRejectPromise() {
       ...
       */
      // eslint-disable-next-line no-unused-vars
      _handleDataFetchEnd: function _handleDataFetchEnd(event) {
       ...
       */
      // eslint-disable-next-line no-unused-vars
      _handleFocusAfterFetch: function _handleFocusAfterFetch() {
        // restore focus
        ...
        if (activeElement.hasClass(this._CSS_CLASSES._PAGING_CONTROL_NAV_PAGE_CLASS)) {
          ...
          setTimeout(function () {
            var navInput = self._getPagingControlContent().find('.' + self._CSS_CLASSES._PAGING_CONTROL_NAV_DOT_CLASS);
       ...
       * @private
       */
      _handleDataPage: function _handleDataPage(event) {
        var pageData = event.detail != null ? event.detail : event;
        var page = pageData.page;
        var previousPage = pageData.previousPage; // only refresh if page has changed
       ...
       */
      // eslint-disable-next-line no-unused-vars
      _handleDataReset: function _handleDataReset(event) {
       ...
       */
      // eslint-disable-next-line no-unused-vars
      _handleDataRefresh: function _handleDataRefresh(event) {
        this._queueRefresh();
      },
       ...
       * @private
       */
      _handleDataSort: function _handleDataSort(event) {
       ...
       * @private
       */
      _handleDataRowAdd: function _handleDataRowAdd(event) {
       ...
       * @private
       */
      _handleDataRowRemove: function _handleDataRowRemove(event) {
        if (this.options.mode === this._MODE._PAGE) {
       ...
       * @private
       */
      _handlePageChange: function _handlePageChange(event, data) {
        var isCustomElement = this._IsCustomElement();
       ...
       * @private
       */
      _invokeUserDataPageFetch: function _invokeUserDataPageFetch(page) {
       ...
       * @private
       */
      _invokeDataPage: function _invokeDataPage(page, async) {
        try {
       ...
       * @private
       */
      _invokeDataSetPage: function _invokeDataSetPage(page) {
        var data = this._getData();
        ...
        return new Promise(function (resolve, reject) {
          if (data != null) {
            ...
            data.setPage(page, {
              ...
              accPageLabel.childNodes[0].nodeValue = self.getTranslatedString(self._BUNDLE_KEY._LABEL_ACC_PAGE_NUMBER, {
                pageNum: page + 1
              });
       ...
       * @private
       */
      _invokeDataFetchNext: function _invokeDataFetchNext() {
       ...
       * @private
       */
      _invokeDataFetch: function _invokeDataFetch(options) {
        var data = this._getData();

        if (!this._isTotalSizeConfidenceActual() || data.totalSize() > this._currentStartIndex && this._isTotalSizeConfidenceActual()) {
          var self = this; // If is dataproviderview, do a setpage with large fetch size instead
       ...
       * @private
       */
      _invokeDataFetchCurrent: function _invokeDataFetchCurrent() {
        var pageSize = this.options.pageSize;
        return this._invokeDataFetch({
          startIndex: 0,
       ...
       * @private
       */
      _isOperationOnCurrentPage: function _isOperationOnCurrentPage(event) {
        if (event == null) {
          return false;
        }
        ...
        var rowIdx; // check if one or more
       ...
       * @private
       */
      _isTotalSizeConfidenceActual: function _isTotalSizeConfidenceActual() {
        var data = this._getData();
      ...
      _queuePageFetch: function _queuePageFetch(page) {
        var self = this;
        ...
        this._pageFetchCount += 1; // keep track of the latest page. We only do a fetch on the latest page.

        this._pageFetchLatestPage = page;
        this._pendingPageFetch = this._pendingPageFetch.then(function () {
          self._pageFetchCount -= 1; // If stop fetch action flag is true, skip the postfetch process.
          ...
          if (self._pageFetchCount === 0 && !self._componentDestroyed) {
            ...
            self._invokeDataSetPage(self._pageFetchLatestPage).then(function () {
              self = null;
            }, function (error) {
      ...
      _queueRefresh: function _queueRefresh() {
        var self = this;
       ...
       * @private
       */
      _refreshPagingControlLoadMore: function _refreshPagingControlLoadMore(size, startIndex) {
        var data = this._getData();

        var pagingControlLoadMore = this._getPagingControlLoadMore();

        var rowCount = startIndex + size;
        var needLoadMore = !(data != null && (rowCount === data.totalSize() && this._isTotalSizeConfidenceActual() || data.totalSize() === 0)); // Recreate loadMore control if this is the first time or there is more data
       ...
       * @private
       */
      _refreshPagingControlNav: function _refreshPagingControlNav(size, startIndex) {
        ...
        if (overflowOption === 'fit') {
          ...
          if (pagingControlNavWidth > elementWidth) {
            ...
            } else if (pagingControlNavWidth - pagingControlNavPageLinksWidth - pagingControlNavInputSummaryWidth <= elementWidth) {
       ...
       */
      // eslint-disable-next-line no-unused-vars
      _refreshPagingControlNavArrows: function _refreshPagingControlNavArrows(size, startIndex) {
        var pageSize = this.options.pageSize;
        ...
        if (pagingControlNavLast && pagingControlNavLast.length > 0) {
          ...
          this._disableNavArrow(pagingControlNavLast, this._getCurrentPage() === this._getTotalPages() - 1 || this._getTotalPages() <= 0 || !this._isTotalSizeConfidenceActual());
        }
        ...
        if (pagingControlNavNext && pagingControlNavNext.length > 0) {
          ...
          this._disableNavArrow(pagingControlNavNext, this._getCurrentPage() === this._getTotalPages() - 1 && this._isTotalSizeConfidenceActual() || this._getTotalPages() === 0 || this._getTotalPages() < 0 && size === 0 || this._getTotalPages() < 0 && size < pageSize);
        }
      },
       ...
       * @private
       */
      _refreshPagingControlNavPages: function _refreshPagingControlNavPages(size, startIndex) {
       ...
       * @private
       */
      _refreshPagingControlNavLabel: function _refreshPagingControlNavLabel() {
        var pagingControlNavInputSection = this._getPagingControlNavInputSection();
       ...
       * @private
       */
      _refreshPagingControlNavInput: function _refreshPagingControlNavInput() {
        var pagingControlNavInput = this._getPagingControlNavInput();
       ...
       * @private
       */
      _refreshPagingControlNavSummaryLabel: function _refreshPagingControlNavSummaryLabel(size, startIndex) {
       ...
       */
      // eslint-disable-next-line no-unused-vars
      _refreshPagingControlNavMaxPageVal: function _refreshPagingControlNavMaxPageVal(size, startIndex) {
        ...
        if (pagingControlNavMaxLabel != null && pagingControlNavMaxLabel.length > 0) {
          ...
          if (this._getTotalPages() > 0 && this._isTotalSizeConfidenceActual()) {
            navInputPageMaxLabel = this.getTranslatedString(this._BUNDLE_KEY._LABEL_NAV_INPUT_PAGE_MAX, {
              pageMax: maxPageVal
            });
          ...
          if (pagingControlNavInputSection != null && this._getTotalPages() > 0 && this._isTotalSizeConfidenceActual() && maxPageVal >= this._getCurrentPage() + 1) {
        ...
        if (!isCustomElement) {
          pagingControlNavInput = this._getPagingControlNav().find('.' + this._CSS_CLASSES._PAGING_CONTROL_NAV_INPUT_CLASS);
        } else {
      ...
      _registerDataSourceEventListeners: function _registerDataSourceEventListeners() {
        ...
        if (data != null && oj.DataProviderFeatureChecker.isDataProvider(data)) {
          ...
          for (var i = 0; i < this._dataSourceEventHandlers.length; i++) {
            var ev = data.on(this._dataSourceEventHandlers[i].eventType, this._dataSourceEventHandlers[i].eventHandler);
       ...
       * @private
       */
      _resetPagingControlNavInput: function _resetPagingControlNavInput() {
        var pagingControlNavInput = this._getPagingControlNavInput();

        var isCustomElement = this._IsCustomElement();

        if (pagingControlNavInput != null && (!isCustomElement && pagingControlNavInput.hasClass('oj-component-initnode') || isCustomElement)) {
          try {
            if (!isCustomElement) {
       ...
       * @private
       */
      _setInitialPage: function _setInitialPage() {
      ...
      _unregisterDataSourceEventListeners: function _unregisterDataSourceEventListeners() {
        ...
        if (data != null && oj.DataProviderFeatureChecker.isDataProvider(data) && this._dataSourceEventHandlers != null) {
          for (i = 0; i < this._dataSourceEventHandlers.length; i++) {
            if (this._dataSourceEventHandlers[i].eventType === 'pageCount') {
              ...
              data.removeEventListener(this._dataSourceEventHandlers[i].eventType, this._dataSourceEventHandlers[i].eventHandler);
            }
          }
       ...
       * @private
       */
      _unregisterSwipeHandler: function _unregisterSwipeHandler() {
        if (DomUtils.isTouchSupported()) {
          var pagingControlNav = this._getPagingControlNav();
       ...
       * @private
       */
      _createAccLabelSpan: function _createAccLabelSpan(text, className) {
       ...
       * @private
       */
      _createAccPageLabel: function _createAccPageLabel() {
        var pagingControlContainer = this._getPagingControlContainer();

        var pagingControlAccPageSpan = document.createElement('span');
        var pagingControlAccText = document.createTextNode(this.getTranslatedString(this._BUNDLE_KEY._LABEL_ACC_PAGE_NUMBER, {
        ...
        pagingControlAccPageSpan.setAttribute('role', 'status'); // workaround for csp violation
       ...
       * @private
       */
      _createPagingControlAccLabel: function _createPagingControlAccLabel() {
        var pagingControlContainer = this._getPagingControlContainer();

        var pagingControlAccLabelText = this.getTranslatedString(this._BUNDLE_KEY._LABEL_ACC_PAGING); // Accessibility label must be unique for role='region'
       ...
       * @private
       */
      _createPagingControlAccNavPageLabel: function _createPagingControlAccNavPageLabel() {
       ...
       * @private
       */
      _createPagingControlContent: function _createPagingControlContent() {
        var pagingControlContainer = this._getPagingControlContainer();
        ...
        var pagingControlAccLabelId = this._getPagingControlAccLabel().attr('id'); // Fix bug 34545: use region as role instead of navigation
       ...
       * @private
       */
      _createPagingControlLoadMore: function _createPagingControlLoadMore() {
        var pagingControlContent = this._getPagingControlContent();
       ...
       * @private
       */
      _createPagingControlLoadMoreLink: function _createPagingControlLoadMoreLink() {
        var pagingControlLoadMore = this._getPagingControlLoadMore();
       ...
       * @private
       */
      _createPagingControlLoadMoreMaxRows: function _createPagingControlLoadMoreMaxRows() {
        var pagingControlLoadMore = this._getPagingControlLoadMore();
       ...
       * @private
       */
      _createPagingControlLoadMoreRange: function _createPagingControlLoadMoreRange(size, startIndex) {
        var pagingControlLoadMore = this._getPagingControlLoadMore();
       ...
       * @private
       */
      _createPagingControlNav: function _createPagingControlNav(size, startIndex) {
        ...
        if ($.inArray(this._PAGE_OPTION_LAYOUT._AUTO, pageOptionLayout) !== -1 && !isDot || $.inArray(this._PAGE_OPTION_LAYOUT._ALL, pageOptionLayout) !== -1 || $.inArray(this._PAGE_OPTION_LAYOUT._INPUT, pageOptionLayout) !== -1) {
          ...
          if (this._getTotalPages() > 0 && this._isTotalSizeConfidenceActual()) {
            ...
            pagingControlNavMaxLabel.addClass(this._CSS_CLASSES._PAGING_CONTROL_NAV_INPUT_MAX_CLASS);
            pagingControlNavMaxLabel.addClass('oj-label-inline');
            var navInputPageMaxLabel = this.getTranslatedString(this._BUNDLE_KEY._LABEL_NAV_INPUT_PAGE_MAX, {
              pageMax: maxPageVal
            });
            pagingControlNavMaxLabel.text(navInputPageMaxLabel);
            pagingControlNavInputSection.append(pagingControlNavMaxLabel); // @HTMLUpdateOK
        ...
        if ($.inArray(this._PAGE_OPTION_LAYOUT._AUTO, pageOptionLayout) !== -1 && !isDot || $.inArray(this._PAGE_OPTION_LAYOUT._ALL, pageOptionLayout) !== -1 || $.inArray(this._PAGE_OPTION_LAYOUT._RANGE_TEXT, pageOptionLayout) !== -1) {
        ...
        if ($.inArray(this._PAGE_OPTION_LAYOUT._AUTO, pageOptionLayout) !== -1 && !isDot || $.inArray(this._PAGE_OPTION_LAYOUT._ALL, pageOptionLayout) !== -1 || $.inArray(this._PAGE_OPTION_LAYOUT._NAV, pageOptionLayout) !== -1) {
          var pagingControlNavFirst = this._createNavArrow(this._CSS_CLASSES._PAGING_CONTROL_NAV_FIRST_CLASS, isVertical ? this._CSS_CLASSES._PAGING_CONTROL_NAV_FIRST_VERTICAL_ICON_CLASS : this._CSS_CLASSES._PAGING_CONTROL_NAV_FIRST_ICON_CLASS, this._BUNDLE_KEY._TIP_NAV_FIRST_PAGE, this._BUNDLE_KEY._LABEL_ACC_NAV_FIRST_PAGE, this._CSS_CLASSES._PAGING_CONTROL_NAV_FIRST_ACC_LABEL_CLASS, isVertical);

          pagingControlNavArrowSection.append(pagingControlNavFirst); // @HTMLUpdateOK

          var pagingControlNavPrevious = this._createNavArrow(this._CSS_CLASSES._PAGING_CONTROL_NAV_PREVIOUS_CLASS, isVertical ? this._CSS_CLASSES._PAGING_CONTROL_NAV_PREVIOUS_VERTICAL_ICON_CLASS : this._CSS_CLASSES._PAGING_CONTROL_NAV_PREVIOUS_ICON_CLASS, this._BUNDLE_KEY._TIP_NAV_PREVIOUS_PAGE, this._BUNDLE_KEY._LABEL_ACC_NAV_PREVIOUS_PAGE, this._CSS_CLASSES._PAGING_CONTROL_NAV_PREVIOUS_ACC_LABEL_CLASS, isVertical);

          pagingControlNavArrowSection.append(pagingControlNavPrevious); // @HTMLUpdateOK
        } // nav pages section


        if ($.inArray(this._PAGE_OPTION_LAYOUT._AUTO, pageOptionLayout) !== -1 || $.inArray(this._PAGE_OPTION_LAYOUT._ALL, pageOptionLayout) !== -1 || $.inArray(this._PAGE_OPTION_LAYOUT._PAGES, pageOptionLayout) !== -1) {
        ...
        if ($.inArray(this._PAGE_OPTION_LAYOUT._AUTO, pageOptionLayout) !== -1 && !isDot || $.inArray(this._PAGE_OPTION_LAYOUT._ALL, pageOptionLayout) !== -1 || $.inArray(this._PAGE_OPTION_LAYOUT._NAV, pageOptionLayout) !== -1) {
          var pagingControlNavNext = this._createNavArrow(this._CSS_CLASSES._PAGING_CONTROL_NAV_NEXT_CLASS, isVertical ? this._CSS_CLASSES._PAGING_CONTROL_NAV_NEXT_VERTICAL_ICON_CLASS : this._CSS_CLASSES._PAGING_CONTROL_NAV_NEXT_ICON_CLASS, this._BUNDLE_KEY._TIP_NAV_NEXT_PAGE, this._BUNDLE_KEY._LABEL_ACC_NAV_NEXT_PAGE, this._CSS_CLASSES._PAGING_CONTROL_NAV_NEXT_ACC_LABEL_CLASS, isVertical);

          pagingControlNavArrowSection.append(pagingControlNavNext); // @HTMLUpdateOK

          var pagingControlNavLast = this._createNavArrow(this._CSS_CLASSES._PAGING_CONTROL_NAV_LAST_CLASS, isVertical ? this._CSS_CLASSES._PAGING_CONTROL_NAV_LAST_VERTICAL_ICON_CLASS : this._CSS_CLASSES._PAGING_CONTROL_NAV_LAST_ICON_CLASS, this._BUNDLE_KEY._TIP_NAV_LAST_PAGE, this._BUNDLE_KEY._LABEL_ACC_NAV_LAST_PAGE, this._CSS_CLASSES._PAGING_CONTROL_NAV_LAST_ACC_LABEL_CLASS, isVertical);
       ...
       */
      // eslint-disable-next-line no-unused-vars
      _createPagingControlNavPages: function _createPagingControlNavPages(parentDiv, numLinks, size, startIndex) {
        if (numLinks < 5) {
          var errSummary = this.getTranslatedString(this._BUNDLE_KEY._ERR_MAXPAGELINKS_INVALID_SUMMARY);
          var errDetail = this.getTranslatedString(this._BUNDLE_KEY._ERR_MAXPAGELINKS_INVALID_DETAIL); // Set stop fetch action flag to prevent page fetches.
        ...
        var pageSize = this.options.pageSize;
        var numPagesToAdd = numLinks; // this will hold our page list
        ...
        if (currentPage >= 0) {
          ...
          if (this._isTotalSizeConfidenceActual() && totalPages <= numPagesToAdd) {
            ...
            pageList[0] = 0; // just enumerate the pages
            ...
            numPagesToAdd -= pageList.length; // keep adding before the current page till we get to the
            // first page or we've added numPagesToAdd - 1.
            // If the last page or 2nd to last page then add until numPagesToAdd

            var pageBeforeCurrent = currentPage - 1; // number of pages to add after current

            var numPagesAfterCurrent = 1; // if at last page or second to last page then don't add any pages
            // after current

            if (this._isTotalSizeConfidenceActual() && (currentPage === totalPages - 1 || currentPage === totalPages - 2)) {
            ...
            var pageAfterCurrent = currentPage + 1; // if unknown row count, only add one page after current if there is data
          ...
          for (i = 0; i < pageList.length; i++) {
            ...
            this._createPagingControlNavPage(pagingControlNavPagesLinks, pageNum); // check if we have a gap
       ...
       * @private
       */
      _createPagingControlNavPage: function _createPagingControlNavPage(parentDiv, pageNum) {
        var currentPage = this._getCurrentPage();
        ...
        if (pageNum === -1) {
          ...
          if (isDot) {
            // hide the number
            pagingControlNavPageSpan.addClass(this._CSS_CLASSES._HIDDEN_CONTENT_ACC_CLASS); // add the dot
       ...
       * @private
       */
      _getPagingControlAccPageLabel: function _getPagingControlAccPageLabel() {
        var pagingControlContainer = this._getPagingControlContainer();

        var pagingControlAccPageLabel = null;

        if (pagingControlContainer) {
          pagingControlAccPageLabel = this.element[0].querySelector('.' + this._CSS_CLASSES._PAGING_CONTROL_ACC_PAGE_LABEL_CLASS);
        }
       ...
       * @private
       */
      _getPagingControlAccLabel: function _getPagingControlAccLabel() {
        var pagingControlContainer = this._getPagingControlContainer();
       ...
       * @private
       */
      _getPagingControlContainer: function _getPagingControlContainer() {
        return $(this.element);
      },
       ...
       * @private
       */
      _getPagingControlContent: function _getPagingControlContent() {
       ...
       * @private
       */
      _getPagingControlLoadMore: function _getPagingControlLoadMore() {
       ...
       * @private
       */
      _getPagingControlNav: function _getPagingControlNav() {
       ...
       * @private
       */
      _getPagingControlNavInput: function _getPagingControlNavInput() {
        var isCustomElement = this._IsCustomElement();
       ...
       * @private
       */
      _getPagingControlNavInputSummary: function _getPagingControlNavInputSummary() {
       ...
       * @private
       */
      _getPagingControlNavPageLinks: function _getPagingControlNavPageLinks() {
        var pagingControlNav = this._getPagingControlNav();
       ...
       * @private
       */
      _getPagingControlNavArrowSection: function _getPagingControlNavArrowSection() {
        var pagingControlNav = this._getPagingControlNav();
       ...
       * @private
       */
      _getPagingControlNavInputSection: function _getPagingControlNavInputSection() {
        var pagingControlNav = this._getPagingControlNav();
