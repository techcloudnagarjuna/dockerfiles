...
define(['exports', 'ojs/ojcore-base', 'ojs/ojlogger'], function (exports, oj, Logger) {
  ...
  var compare = ResponsiveUtils.compare;
  var getFrameworkQuery = ResponsiveUtils.getFrameworkQuery;
  var SCREEN_RANGE = ResponsiveUtils.SCREEN_RANGE;
  var FRAMEWORK_QUERY_KEY = ResponsiveUtils.FRAMEWORK_QUERY_KEY;
