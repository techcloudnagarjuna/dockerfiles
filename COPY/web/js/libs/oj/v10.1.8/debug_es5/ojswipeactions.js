 ...
 * @ignore
 */
define(['ojs/ojoption', 'touchr', 'ojs/ojcore-base', 'jquery', 'ojs/ojdomutils', 'ojs/ojcontext', 'ojs/ojconfig', 'ojs/ojoffcanvas', 'ojs/ojswipetoreveal', 'ojs/ojcustomelement-utils'], function (ojoption, touchr, oj, $, DomUtils, Context, ojconfig, ojoffcanvas, ojswipetoreveal, ojcustomelementUtils) {
  'use strict';
    ...
    */
    ...
    oj.__registerWidget('oj.ojSwipeActions', $.oj.baseComponent, {
      ...
      _ComponentCreate: function _ComponentCreate() {
        ...
        this.element[0].setAttribute('tabIndex', '-1'); // pass true to catch these events on all menus, not just enabled menus
      ...
      _close: function _close(offcanvasInfo) {
        ...
        ojoffcanvas.close(offcanvasInfo).then(function () {
          busyStateResolve();
        });
      },
      ...
      _setup: function _setup() {
        ...
        var slotMap = ojcustomelementUtils.CustomElementUtils.getSlotMap(this.element[0]); // default slot is content
      ...
      _doAction: function _doAction(action) {
        return new Promise(function (resolve) {
          ...
          if (option != null) {
            ...
            if (offcanvas != null && offcanvas.childElementCount === 0 && offcanvas._checked === undefined) {
              offcanvas._checked = true;

              this._renderOffcanvas(offcanvas, function () {
