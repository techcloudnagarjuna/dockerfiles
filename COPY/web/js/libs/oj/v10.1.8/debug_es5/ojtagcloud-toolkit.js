...
define(['exports', 'ojs/ojdvt-toolkit'], function (exports, dvt) {
  ...
  var DvtTagCloudKeyboardHandler = function DvtTagCloudKeyboardHandler(manager) {
    this.Init(manager);
  };
  ...
  DvtTagCloudKeyboardHandler.getNextNavigable = function (currentNavigable, event, navigableItems) {
    ...
    if (nextIdx < navigableItems.length && nextIdx >= 0) return navigableItems[nextIdx];else return null;
  };
  /**
   * @license
   * Copyright (c) 2014, 2022, Oracle and/or its affiliates.
  ...
  var DvtTagCloudObjPeer$1 = function DvtTagCloudObjPeer$1(tagCloud, displayable, data) {
    this.Init(tagCloud, displayable, data);
  };

  dvt.Obj.createSubclass(DvtTagCloudObjPeer$1, dvt.Obj);
  /**
   * @param {dvt.TagCloud} tagCloud The owning component
   * @param {dvt.Displayable} displayable The of associated dvt.Displayable.
   * @param {object} data The data associated with the tag cloud item.
  ...
  DvtTagCloudObjPeer$1.prototype.Init = function (tagCloud, displayable, data) {
    this._view = tagCloud;
    this._displayable = displayable;
    this._data = data;
    this._isSelected = false;
    this._bSelectable = false; // A11y
  ...
  DvtTagCloudObjPeer$1.prototype.getId = function () {
  ...
  DvtTagCloudObjPeer$1.prototype.getLabel = function () {
  ...
  DvtTagCloudObjPeer$1.prototype.getValue = function () {
  ...
  DvtTagCloudObjPeer$1.prototype.getShortDesc = function () {
  ...
  DvtTagCloudObjPeer$1.prototype.getDatatip = function () {
    ...
    if (tooltipFunc) return this._view.getCtx().getTooltipManager().getCustomTooltip(tooltipFunc, this.getDataContext()); // Custom Tooltip from ShortDesc
  ...
  DvtTagCloudObjPeer$1.prototype.getDataContext = function () {
    return {
      'id': this.getId(),
      'label': this.getLabel(),
  ...
  DvtTagCloudObjPeer$1.prototype.getLinkCallback = function () {
  ...
  DvtTagCloudObjPeer$1.prototype.getDatatipColor = function () {
  ...
  DvtTagCloudObjPeer$1.prototype.setSelectable = function (bSelectable) {
  ...
  DvtTagCloudObjPeer$1.prototype.isSelectable = function () {
  ...
  DvtTagCloudObjPeer$1.prototype.isSelected = function () {
  ...
  DvtTagCloudObjPeer$1.prototype.setSelected = function (bSelected) {
  ...
  DvtTagCloudObjPeer$1.prototype.showHoverEffect = function () {
  ...
  DvtTagCloudObjPeer$1.prototype.hideHoverEffect = function () {
  ...
  DvtTagCloudObjPeer$1.prototype.getKeyboardBoundingBox = function (targetCoordinateSpace) {
  ...
  DvtTagCloudObjPeer$1.prototype.getTargetElem = function () {
  ...
  DvtTagCloudObjPeer$1.prototype.showKeyboardFocusEffect = function () {
  ...
  DvtTagCloudObjPeer$1.prototype.hideKeyboardFocusEffect = function () {
  ...
  DvtTagCloudObjPeer$1.prototype.isShowingKeyboardFocusEffect = function () {
  ...
  DvtTagCloudObjPeer$1.prototype.getDisplayables = function () {
  ...
  DvtTagCloudObjPeer$1.prototype.getAriaLabel = function () {
    var states = [];
  ...
  DvtTagCloudObjPeer$1.prototype.getCategories = function () {
  ...
  DvtTagCloudObjPeer$1.prototype._updateAriaLabel = function () {
  ...
  DvtTagCloudObjPeer$1.prototype.isDragAvailable = function (clientIds) {
  ...
  DvtTagCloudObjPeer$1.prototype.getDragTransferable = function (mouseX, mouseY) {
  ...
  DvtTagCloudObjPeer$1.prototype.getDragFeedback = function (mouseX, mouseY) {
  ...
  var DvtTagCloudAutomation = function DvtTagCloudAutomation(dvtComponent) {
  ...
  DvtTagCloudAutomation.prototype.GetSubIdForDomElement = function (displayable) {
    ...
    if (logicalObj && logicalObj instanceof DvtTagCloudObjPeer$1) {
  ...
  DvtTagCloudAutomation.prototype.getDomElementForSubId = function (subId) {
    if (subId == dvt.Automation.TOOLTIP_SUBID) return this.GetTooltipElement(this._tagCloud);
    ...
    if (parenIdx > 0 && subId.substring(0, parenIdx) === 'item') {
      ...
      if (peer) return peer.getDisplayables()[0].getElem();else return null;
    }
  ...
  var DvtTagCloudDefaults = function DvtTagCloudDefaults(context) {
    this.Init({
      'alta': DvtTagCloudDefaults.VERSION_1
    }, context);
  };
  ...
  var DvtTagCloudEventManager = function DvtTagCloudEventManager(view, context, callback, callbackObj) {
  ...
  DvtTagCloudEventManager.prototype._handleLinkCallback = function (obj) {
    if (obj instanceof DvtTagCloudObjPeer$1) {
  ...
  var DvtTagCloudItem = function DvtTagCloudItem(tagCloud, context, textStr, x, y, style, itemStyle, styleClass, id) {
  ...
  DvtTagCloudItem.prototype.Init = function (tagCloud, context, textStr, x, y, style, itemStyle, styleClass, id) {
    ...
    this.alignAuto(); // If itemStyle or styleClass is specified, it will be directly applied to the tag cloud item SVG text
  ...
  DvtTagCloudItem.prototype.setSelected = function (bSelected) {
    ...
    if (bSelected) {
      if (this._isShowingHoverEffect) this.setCSSStyle(this._hoverSelectedStyle);else this.setCSSStyle(this._selectedStyle);
    } else {
  ...
  DvtTagCloudItem.prototype.showHoverEffect = function () {
    if (!this._isShowingHoverEffect) {
      ...
      if (this._isSelected) this.setCSSStyle(this._hoverSelectedStyle);else this.setCSSStyle(this._hoverStyle);
    }
  };
  /**
  ...
  DvtTagCloudItem.prototype.hideHoverEffect = function () {
    if (this._isSelected) this.setCSSStyle(this._selectedStyle);else this.setCSSStyle(this._normalStyle);
  ...
  DvtTagCloudItem.prototype.animateUpdate = function (handler, oldObj) {
    ...
    var bSizeChange = false; // Color change
    ...
    if (startColor != endColor) {
      ...
      var setColorStyle = function setColorStyle(value) {
  ...
  DvtTagCloudItem._adjustX = function (tag, x, hAlign) {
    ...
    if (hAlign == dvt.OutputText.H_ALIGN_LEFT) return x + dims.w;else if (hAlign == dvt.OutputText.H_ALIGN_RIGHT) return x - dims.w;else return x;
  };
  /**
  ...
  var DvtTagCloudLayoutUtils = function DvtTagCloudLayoutUtils() {};
  ...
  DvtTagCloudLayoutUtils.getFontSizeFunction = function (minValue, maxValue, range) {
    return function (value) {
      return minValue === maxValue ? 12 : 12 + Math.ceil((range - 1) * (value - minValue) / (maxValue - minValue) * 12);
    };
  };
  /**
  ...
  DvtTagCloudLayoutUtils.cloudLayout = function (availSpace, items) {
    ...
    var xrStep = 10 / steps;
    var yrStep = 10 / steps;
    if (availSpace.w > availSpace.h) xrStep *= availSpace.w / availSpace.h;else yrStep *= availSpace.h / availSpace.w;
    ...
    for (var i = 0; i < items.length; i++) {
      ...
      while (!placed) {
        ...
        if (step === 3600) // 20 loops
          stepIncrement = 3;else if (step === 5400) // 30 loops
          stepIncrement = 2;else if (step === 10800) // 60 loops
          stepIncrement = 1;
        step += stepIncrement;
      }
    }
  ...
  DvtTagCloudLayoutUtils.rectangleLayout = function (availSpace, items, isBidi) {
    ...
    var maxFontSize = 0;
    var vPadding = 2;
    var margin = 5; // Get the unscaled dimensions
  ...
  DvtTagCloudRenderer._renderEmptyText = function (tagCloud, container, availSpace) {
    ...
    tagCloud.renderEmptyText(container, emptyTextStr, new dvt.Rectangle(availSpace.x, availSpace.y, availSpace.w, availSpace.h), tagCloud.EventManager, options['_statusMessageStyle']);
  };
  /**
  ...
  DvtTagCloudRenderer._renderItems = function (tagCloud, container, availSpace) {
    ...
    var maxValue = -Number.MAX_VALUE; // First iterate thru data items to find the min and max values
    ...
    var fontSizeFunction = DvtTagCloudLayoutUtils.getFontSizeFunction(minValue, maxValue, 3); // create a boolean map of hidden categories for better performance

    var categoryMap = dvt.ArrayUtils.createBooleanMap(options['hiddenCategories']); //Text measurement properties

    var textProperties = dvt.CSSStyle.getTextMeasurementProperties(); //Public default style

    var styleDefaults = options['styleDefaults'];
    var defaultStyle = styleDefaults['svgStyle'] || styleDefaults['style'];
    if (defaultStyle && !(defaultStyle instanceof Object)) defaultStyle = dvt.CSSStyle.cssStringToObject(defaultStyle); //Process tag cloud items

    for (var i = 0; i < dataItems.length; i++) {
      var data = dataItems[i]; // Default categories array to array of tag label if none provided
      ...
      if (itemStyle && !(itemStyle instanceof Object)) itemStyle = dvt.CSSStyle.cssStringToObject(itemStyle); //Order of precedence of processing item color is,
      //Item style color > Data item color > Public default style color.

      var color = itemStyle && itemStyle['color'] ? itemStyle['color'] : data['color'] ? data['color'] : defaultStyle && defaultStyle['color'] ? defaultStyle['color'] : null; //Merge the item style and public default style
      ...
      if (peer.isSelectable() || data['url']) item.setCursor(dvt.SelectionEffectUtils.getSelectingCursor());
      items.push(item);
    ...
    if (items.length > 0) {
      if (options['layout'] === 'cloud') DvtTagCloudLayoutUtils.cloudLayout(availSpace, items);else DvtTagCloudLayoutUtils.rectangleLayout(availSpace, items, dvt.Agent.isRightToLeft(tagCloud.getCtx()));
    }
  ...
  DvtTagCloudRenderer._renderLegend = function (tagCloud, container, availSpace) {
    ...
    if (legendData && legendData['sections']) {
      ...
      dvt.LayoutUtils.position(availSpace, 'bottom', legend, preferredSize.w, preferredSize.h, 0); // Destroy the legend and remove event listeners
  ...
  var TagCloud = function TagCloud(context, callback, callbackObj) {
    this.Init(context, callback, callbackObj);
  };

  dvt.Obj.createSubclass(TagCloud, dvt.BaseComponent); // TODO ADD TESTS: AUTOMATION & DVT-SHARED-JS
  ...
  TagCloud.newInstance = function (context, callback, callbackObj) {
  ...
  TagCloud.prototype.Init = function (context, callback, callbackObj) {
    TagCloud.superclass.Init.call(this, context, callback, callbackObj);
    this.getCtx().getStage().getElem().setAttributeNS(null, 'text-rendering', 'geometricPrecision'); // Create the event handler and add event listeners
    ...
    if (!dvt.Agent.isTouchDevice()) this.EventManager.setKeyboardHandler(new DvtTagCloudKeyboardHandler(this.EventManager)); // Create the defaults object
    ...
    this.legend = null; // Drag and drop support - not used in JET
  ...
  TagCloud.prototype.render = function (options, width, height) {
    ...
    this.SetOptions(options); // Animation Support
    // Stop any animation in progress

    this.StopAnimation(); // Update old references
    ...
    DvtTagCloudRenderer.render(this, this._container, new dvt.Rectangle(0, 0, this.Width, this.Height)); // Initial Selection

    if (this.SelectionHandler) this.SelectionHandler.processInitialSelections(this.Options['selection'], this.getObjects()); // Construct the new animation playable
  ...
  TagCloud.prototype.registerItems = function (items) {
    this._items = items;
  };
  /**
  ...
  TagCloud.prototype.getAutomation = function () {
  ...
  TagCloud.prototype.registerObject = function (peer, index) {
  ...
  TagCloud.prototype.getObjects = function () {
    return this._peers;
  };
  /**
  ...
  TagCloud.prototype.getItems = function () {
  ...
  TagCloud.prototype.highlight = function (categories) {
    // Update the options
  ...
  TagCloud.prototype.select = function (selection) {
    // Update the options
    this.Options['selection'] = dvt.JsonUtils.clone(selection); // Perform the selection

    if (this.SelectionHandler) this.SelectionHandler.processInitialSelections(this.Options['selection'], this.getObjects());
  };
  /**
   * @override
   */
  ...
  TagCloud.prototype.SetOptions = function (options) {
    ...
    if (selectionMode === 'single') this.SelectionHandler = new dvt.SelectionHandler(this.getCtx(), dvt.SelectionHandler.TYPE_SINGLE);else if (selectionMode === 'multiple') this.SelectionHandler = new dvt.SelectionHandler(this.getCtx(), dvt.SelectionHandler.TYPE_MULTIPLE);else this.SelectionHandler = null; // Pass to event handler
  ...
  TagCloud.prototype.OnRenderEnd = function () {
    ...
    if (this.Options['highlightedCategories'] && this.Options['highlightedCategories'].length > 0) this.highlight(this.Options['highlightedCategories']);
  ...
  TagCloud.prototype.__cleanUp = function () {
  ...
  TagCloud.prototype.processEvent = function (event, source) {
    ...
    if (type == 'categoryHide' || type == 'categoryShow') {
      ...
      if (this != source) this.highlight(event['categories']);else if (this.legend && this.legend != source) this.legend.processEvent(event, source);
  ...
  TagCloud.prototype.isDragSupported = function (clientIds) {
    // Drag and drop supported when selection is enabled, only 1 drag source
    if (this.SelectionHandler) return clientIds[0];else return null;
  };
  /**
  ...
  TagCloud.prototype.getDragRowKeys = function (peer) {
  ...
  TagCloud.prototype.getDragFeedback = function () {
