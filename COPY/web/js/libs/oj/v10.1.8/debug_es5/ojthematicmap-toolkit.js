 ...
 * @ignore
 */
define(['exports', 'ojs/ojdvt-toolkit', 'ojs/ojdvt-panzoomcanvas'], function (exports, dvt, ojdvtPanzoomcanvas) {
  'use strict';
  /**
   * @license
   * Copyright (c) 2014, 2022, Oracle and/or its affiliates.
  ...
  if (null) {
    if (null['DvtBaseMapManager']) {
      exports.DvtBaseMapManager = null['DvtBaseMapManager'];
    } else {
      exports.DvtBaseMapManager = {};
      null['DvtBaseMapManager'] = exports.DvtBaseMapManager;
      exports.DvtBaseMapManager['_UNPROCESSED_MAPS'] = [[], [], []];
      exports.DvtBaseMapManager['_UNPROCESSED_PARENT_UPDATES'] = [[]];
    }
  } else {
    if (window['DvtBaseMapManager']) {
      ...
      exports.DvtBaseMapManager = {};
      window['DvtBaseMapManager'] = exports.DvtBaseMapManager;
      exports.DvtBaseMapManager['_UNPROCESSED_MAPS'] = [[], [], []];
      exports.DvtBaseMapManager['_UNPROCESSED_PARENT_UPDATES'] = [[]];
    }
  }

  dvt.Obj.createSubclass(exports.DvtBaseMapManager, dvt.Obj);
  /** @const */

  exports.DvtBaseMapManager.TYPE_LABELS = 0; // contain region labels

  /** @const */

  exports.DvtBaseMapManager.TYPE_PATH = 1; // contain region paths

  /** @const */

  exports.DvtBaseMapManager.TYPE_PARENTREGION_CHILDREN = 2; // contains parent region id to current region id mappings.  Stored this way since mapping is only needed if child layer is present.

  /** @const */

  exports.DvtBaseMapManager.TYPE_LABELINFO = 3; // contains leaderline info

  /** @const */

  exports.DvtBaseMapManager.TYPE_DIM = 4; //basemap dimensions

  /** @const @private */

  exports.DvtBaseMapManager._INDEX = '__index';
  /** @const @private */

  exports.DvtBaseMapManager._GLOBAL_MAPS = new Object();
  /**
  ...
  exports.DvtBaseMapManager.getBaseMapDim = function (baseMapName, layerName) {
  ...
  exports.DvtBaseMapManager.getAreaLabelInfo = function (baseMapName, layerName) {
    exports.DvtBaseMapManager._processUnprocessedMaps();

    var layer = exports.DvtBaseMapManager._GLOBAL_MAPS[baseMapName][layerName];
    if (layer) return layer[exports.DvtBaseMapManager.TYPE_LABELINFO];else return null;
  };
  /**
  ...
  exports.DvtBaseMapManager.getAreaIds = function (baseMapName, layerName) {
    var areanames = [];
  ...
  exports.DvtBaseMapManager.getAreaLabels = function (baseMapName, layerName) {
    exports.DvtBaseMapManager._processUnprocessedMaps();

    var layer = exports.DvtBaseMapManager._GLOBAL_MAPS[baseMapName][layerName];
    if (layer) return layer[exports.DvtBaseMapManager.TYPE_LABELS];else return null;
  };
  /**
  ...
  exports.DvtBaseMapManager.getLongAreaLabel = function (baseMapName, layerName, areaId) {
    exports.DvtBaseMapManager._processUnprocessedMaps();
  ...
  exports.DvtBaseMapManager.getCityCoordinates = function (baseMapName, city) {
    exports.DvtBaseMapManager._processUnprocessedMaps();
  ...
  exports.DvtBaseMapManager.getCityLabel = function (baseMapName, city) {
    exports.DvtBaseMapManager._processUnprocessedMaps();
  ...
  exports.DvtBaseMapManager.getAreaCenter = function (baseMapName, layerName, areaId) {
    exports.DvtBaseMapManager._processUnprocessedMaps();
    ...
    if (basemap) {
      ...
      if (layer) {
        var labelInfo = layer[exports.DvtBaseMapManager.TYPE_LABELINFO];
  ...
  exports.DvtBaseMapManager.getAreaPaths = function (baseMapName, layerName, viewportW, viewportH, zoomFactor) {
    exports.DvtBaseMapManager._processUnprocessedMaps();

    var layer = exports.DvtBaseMapManager._GLOBAL_MAPS[baseMapName][layerName];
    var paths = layer[exports.DvtBaseMapManager.TYPE_PATH];
    var dimAr = layer[exports.DvtBaseMapManager.TYPE_DIM];
    if (dimAr) return exports.DvtBaseMapManager._simplifyAreaPaths(paths, dimAr[2], dimAr[3], viewportW, viewportH, zoomFactor);
    return paths;
  };
  /**
  ...
  exports.DvtBaseMapManager.getPathForArea = function (baseMapName, layerName, area) {
    exports.DvtBaseMapManager._processUnprocessedMaps();
  ...
  exports.DvtBaseMapManager.registerBaseMapLayer = function (baseMapName, layerName, labelMetadata, pathMetadata, parentsRegionMetadata, labelInfoMetadata, index, dim) {
    ...
    if (!basemapMetadata) {
      ...
      basemapMetadata[exports.DvtBaseMapManager._INDEX] = new Array();
      exports.DvtBaseMapManager._GLOBAL_MAPS[baseMapName] = basemapMetadata;
    ...
    layerMetadata[exports.DvtBaseMapManager.TYPE_PATH] = pathMetadata;
    layerMetadata[exports.DvtBaseMapManager.TYPE_PARENTREGION_CHILDREN] = parentsRegionMetadata;
    layerMetadata[exports.DvtBaseMapManager.TYPE_LABELINFO] = labelInfoMetadata;
    layerMetadata[exports.DvtBaseMapManager.TYPE_DIM] = dim;
    layerMetadata[exports.DvtBaseMapManager._INDEX] = index;
  };
  /**
  ...
  exports.DvtBaseMapManager.registerResourceBundle = function (baseMapName, layerName, labelMetadata) {
    var basemapMetadata = exports.DvtBaseMapManager._GLOBAL_MAPS[baseMapName];
  ...
  exports.DvtBaseMapManager.updateResourceBundle = function (baseMapName, layerName, labelMetadata) {
    var basemapMetadata = exports.DvtBaseMapManager._GLOBAL_MAPS[baseMapName];
    ...
    if (basemapMetadata) {
      ...
      if (layerMetadata) {
        for (var prop in labelMetadata) {
          layerMetadata[exports.DvtBaseMapManager.TYPE_LABELS][prop] = labelMetadata[prop];
        }
      }
    }
  };
  ...
  exports.DvtBaseMapManager._processUnprocessedMaps = function () {
    var i;
    var args;
    ...
    var unprocessedParentUpdates = exports.DvtBaseMapManager['_UNPROCESSED_PARENT_UPDATES'];
    ...
    if (unprocessedParentUpdates) {
      for (i = 0; i < unprocessedParentUpdates[0].length; i++) {
        ...
        if (basemapMetadata) {
          ...
          if (layerMetadata) {
            layerMetadata[exports.DvtBaseMapManager.TYPE_PARENTREGION_CHILDREN] = args[3];
            basemapDim = layerMetadata[exports.DvtBaseMapManager.TYPE_DIM]; // get the index of the extended layer and update indicies for layers

            var index = layerMetadata[exports.DvtBaseMapManager._INDEX];
          ...
          if (layerMetadata) {
            layerMetadata[exports.DvtBaseMapManager.TYPE_DIM] = basemapDim;
          }
        }
      }
  ...
  exports.DvtBaseMapManager._simplifyAreaPaths = function (paths, basemapW, basemapH, viewportW, viewportH, zoomFactor) {
  ...
  exports.DvtBaseMapManager.getLayerIds = function (baseMapName, layerName) {
    exports.DvtBaseMapManager._processUnprocessedMaps();
  ...
  DvtMapAreaLayer.prototype.getLayerDim = function () {
    if (!this._layerDim) {
      ...
      if (this._isolatedArea) {
        ...
        if (!basemap) this._layerDim = dvt.DisplayableUtils.getDimensionsForced(this._tmap.getCtx(), this.getAreaShape(this._isolatedArea));else this._layerDim = dvt.PathUtils.getDimensions(dvt.PathUtils.createPathArray(exports.DvtBaseMapManager.getPathForArea(this._tmap.getMapName(), this.LayerName, this._isolatedArea)));
      } else {
        if (basemap && basemap != 'world' && basemap != 'worldRegions') this._layerDim = exports.DvtBaseMapManager.getBaseMapDim(this._tmap.getMapName(), this.LayerName);
  ...
  var DvtThematicMapUtils = {
     ...
     * @return {string}
     */
    calcCurve: function calcCurve(dataLayer, origStartPt, origEndPt, startPt, endPt) {
      var x1 = startPt.x;
      var y1 = startPt.y;
      var x2 = endPt.x;
      var y2 = endPt.y;
     ...
     */
    getFirstNavigableLink: function getFirstNavigableLink(marker, event, listOfLinks) {
  ...
  DvtThematicMapEventManager.prototype.OnComponentTouchClick = function (event) {
    var consumed = this.GetEventInfo(event, ojdvtPanzoomcanvas.PanZoomCanvasEventManager.EVENT_INFO_PANNED_KEY);
    if (consumed) return;
    var obj = this.GetLogicalObject(event.target);
    this.SetClickInfo(obj); // If logical object is ThematicMap, then background was tapped and we should call data layer
  ...
  DvtThematicMapJsonParser.prototype._parseAreaLayer = function (areaLayers) {
    ...
    if (this._mapProvider) {
      ...
      paths = exports.DvtBaseMapManager.getAreaPaths(basemap, layer, this._tmap.getWidth(), this._tmap.getHeight(), this._tmap.getMaxZoomFactor());
  ...
  DvtThematicMapJsonParser.getCenter = function (dataLayer, location, x, y) {
    ...
    if (location) {
      var cityCoords = exports.DvtBaseMapManager.getCityCoordinates(mapName, location);

      if (cityCoords) {
        return cityCoords;
      }

      var areaCenter = exports.DvtBaseMapManager.getAreaCenter(mapName, layerName, location);
  ...
  DvtThematicMapJsonParser._getLocationName = function (basemap, dataLayer, data) {
    ...
    if (location) {
      ...
      if (!(mapLayer instanceof DvtMapAreaLayer)) return exports.DvtBaseMapManager.getCityLabel(basemap, location);else return mapLayer.getLongAreaName(location);
    }
  ...
  dvt.Obj.createSubclass(DvtThematicMapKeyboardHandler, ojdvtPanzoomcanvas.PanZoomCanvasKeyboardHandler);
  /**
   * @override
   */
  ...
  var ThematicMap = function ThematicMap(context, callback, callbackObj) {
    this.Init(context, callback, callbackObj);
  };

  dvt.Obj.createSubclass(ThematicMap, ojdvtPanzoomcanvas.PanZoomComponent);
  /**
   * @const
   */
  ...
  ThematicMap.prototype.PreRender = function () {
    ThematicMap.superclass.PreRender.call(this); // Set map changed flag before parsing and rendering
  ...
  ThematicMap.prototype.Render = function () {
    ThematicMap.superclass.Render.call(this); // Create a new container and render the component into it
  ...
  ThematicMap.prototype.handleTouchStart = function () {// noop: Called from HandleImmediateTouchStartInternal
  };
  /**
  ...
  exports.ThematicMap = ThematicMap;
