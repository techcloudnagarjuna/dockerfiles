 ...
 * @ignore
 */
define(['exports', 'ojs/ojcustomelement-utils'], function (exports, ojcustomelementUtils) {
  'use strict';

  function getDescriptiveText(element) {
    var _a;

    var state = ojcustomelementUtils.CustomElementUtils.getElementState(element);
