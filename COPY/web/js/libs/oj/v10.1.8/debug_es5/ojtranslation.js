 ...
 * @ignore
 */
define(['exports', 'ojs/ojcore-base', 'ojs/ojconfig'], function (exports, oj, Config) {
  'use strict';
  ...
  var setBundle = Translations.setBundle;
  var getResource = Translations.getResource;
  var applyParameters = Translations.applyParameters;
  var getTranslatedString = Translations.getTranslatedString;
  var getComponentTranslations = Translations.getComponentTranslations;
