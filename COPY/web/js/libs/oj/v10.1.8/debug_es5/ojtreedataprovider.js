...
define(['ojs/ojcore'], function (oj) {
  ...
  var TreeDataProvider = function TreeDataProvider() {}; // mapping variable definition, used in a no-require environment. Maps the TreeDataProvider function object to the name used in the require callback.
