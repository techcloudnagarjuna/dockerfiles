  ...
  (function () {
    oj.__registerWidget('oj.ojTreeView', $.oj.baseComponent, {
      ...
      */
      ...
      _getItemsInSelectedKeySet: function _getItemsInSelectedKeySet(selected) {
        var _this5 = this;
        ...
        selected.values().forEach(function (key) {
          var item = _this5._getItemByKey(key);
      ...
      */
      ...
      _initLeafOnlySelectionMode: function _initLeafOnlySelectionMode() {
        ...
        this.treeviewSelectionManager = new TreeviewSelectionManager(this._rawData, attributesMap, function (m) {
          return _this6.options.data.createOptimizedKeyMap(m);
        }, function (s) {
          return _this6.options.data.createOptimizedKeySet(s);
        });
       ...
       * @private
       */
      _updateIndeterminateState: function _updateIndeterminateState(partialParents) {
      ...
      */
      ...
      _setupSelector: function _setupSelector(key, isEmpty) {
        if (this._isDefaultCheckBoxesEnabled()) {
       ...
       *
       */
      _getSelectedItemContents: function _getSelectedItemContents() {
        return this.element[0].getElementsByClassName('oj-treeview-item-content oj-selected');
      },
      ...
      _filterOutParentKeys: function _filterOutParentKeys(currentKeys) {
        ...
        if (currentKeys.isAddAll()) {
          ...
          var deletedLeafValues = _toConsumableArray(currentKeys.deletedValues()).filter(function (key) {
            return !_this7.treeviewSelectionManager.parentKeyNodeMap.has(key);
          });
