...
define(function () {
  ...
  UrlPathAdapter.prototype.getRoutesForUrl = function (url) {
    ...
    var routes = []; // Build a route for each path segment
  ...
  UrlPathAdapter.prototype.getUrlForRoutes = function (routes) {
    ...
    routes.forEach(function (route) {
      var params = buildParamsString(route.params || {});
      paths.push(route.path + params);
    });
    var baseUrl = this._baseUrl;
    var fullPath = paths.join('/'); // If paths, ensure trailing slash on baseUrl
