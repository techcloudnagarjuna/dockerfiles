 ...
 * @ignore
 */
define(['exports', 'ojs/ojcore', 'ojs/ojmessaging'], function (exports, oj, Message) {
  'use strict';
  ...
  var ValidatorError = function ValidatorError(summary, detail) {
    var message = {
      summary: summary,
      detail: detail,
  ...
  var ConverterError = function ConverterError(summary, detail) {
    var message = {
      summary: summary,
      detail: detail,
      severity: Message.SEVERITY_LEVEL.ERROR
