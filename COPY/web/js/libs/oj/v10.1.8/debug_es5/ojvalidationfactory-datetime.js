 ...
 * @ignore
 */
define(['ojs/ojcore', 'ojs/ojvalidationfactory-base', 'ojs/ojconverter-datetime', 'ojs/ojvalidator-datetimerange', 'ojs/ojvalidator-daterestriction'], function (oj, __ValidationFactoryBase, __ConverterDateTime, DateTimeRangeValidator, DateRestrictionValidator) {
  "use strict";
  ...
  __ValidationFactoryBase.Validation.__registerDefaultConverterFactory(__ValidationFactoryBase.ConverterFactory.CONVERTER_TYPE_DATETIME, // factory name
  DateTimeConverterFactory); // JET VALIDATOR FACTORIES
  ...
  __ValidationFactoryBase.Validation.__registerDefaultValidatorFactory(__ValidationFactoryBase.ValidatorFactory.VALIDATOR_TYPE_DATETIMERANGE, DateTimeRangeValidatorFactory);
  /**
  ...
  __ValidationFactoryBase.Validation.__registerDefaultValidatorFactory(__ValidationFactoryBase.ValidatorFactory.VALIDATOR_TYPE_DATERESTRICTION, DateRestrictionValidatorFactory);
