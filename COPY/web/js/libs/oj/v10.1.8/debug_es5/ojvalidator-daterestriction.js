 ...
 * @ignore
 */
define(['ojs/ojcore', 'ojs/ojtranslation', 'ojs/ojvalidator', 'ojs/ojvalidation-error', 'ojs/ojconverter-datetime', 'ojs/ojconverterutils-i18n', 'ojs/ojconverterutils'], function (oj, Translations, Validator, ojvalidationError, DateTimeConverter, ConverterUtilsI18n, ConverterUtils) {
  'use strict';
  ...
  DateRestrictionValidator.prototype.validate = function (value) {
    ...
    var valueDateParam = value ? ConverterUtilsI18n.IntlConverterUtils._dateTime(value, ['fullYear', 'month', 'date'], true) : null;
    ...
    if (this._inDisabled(valueDateParam)) {
      var generateValidationError = function generateValidationError(valueStr) {
        summary = messageSummary ? translations.applyParameters(messageSummary, {
          value: valueStr
        }) : translations.getTranslatedString('oj-validator.restriction.date.messageSummary', {
          value: valueStr
        });
        detail = messageDetail ? translations.applyParameters(messageDetail, {
          value: valueStr
