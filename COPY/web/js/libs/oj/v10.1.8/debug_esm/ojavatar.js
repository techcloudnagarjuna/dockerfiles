...
let Avatar = class Avatar extends ElementVComponent {
    render() {
        ...
        let innerContent;
        if (props.src) {
            innerContent = (h("div", { class: 'oj-avatar-background-image', style: { backgroundImage: `url("${props.src}")` } }));
        }
        else if (props.initials) {
            innerContent = (h("div", { class: 'oj-avatar-initials oj-avatar-background-image' }, props.initials));
        }
        else {
            innerContent = (h("div", { class: 'oj-avatar-background-image' },
                h("div", { class: 'oj-avatar-placeholder' })));
        }
        return (h("div", { class: classNameObj, "aria-hidden": 'true' }, innerContent));
    }
};
Avatar.metadata = { "extension": { "_DEFAULTS": Props }, "properties": { "background": { "type": "string", "enumValues": ["neutral", "orange", "green", "teal", "blue", "slate", "mauve", "pink", "purple", "lilac", "gray", "red", "forest"], "value": "neutral" }, "initials": { "type": "string|null", "value": null }, "size": { "type": "string", "enumValues": ["xxs", "xs", "sm", "md", "lg", "xl", "xxl"], "value": "md" }, "src": { "type": "string|null", "value": null } } };
Avatar = __decorate([
