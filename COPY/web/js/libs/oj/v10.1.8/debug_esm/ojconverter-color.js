...
// Subclass from Converter
  ...
  */
  ...
  ColorConverter._throwInvalidColorSyntax = function () {
    var summary = getTranslatedString('oj-converter.color.invalidSyntax.summary');
    var detail = getTranslatedString('oj-converter.color.invalidSyntax.detail');

    var ce = new ConverterError(summary, detail);
  ...
  ColorConverter._throwInvalidColorFormatOption = function () {
    var summary = getTranslatedString('oj-converter.color.invalidFormat.summary');
    var detail = getTranslatedString('oj-converter.color.invalidFormat.detail');
