...
class FlattenedTreeDataProviderView {
    constructor(dataProvider, options) {
        ...
        if (!self.options.expanded) {
            self.options.expanded = new ExpandedKeySet([]);
        }
        self._expandedObservable = new BehaviorSubject(self._getExpandedObservableValue(self.options.expanded, Promise.resolve()));
