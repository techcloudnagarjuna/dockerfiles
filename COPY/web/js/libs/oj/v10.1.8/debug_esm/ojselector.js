...
let Selector = class Selector extends ElementVComponent {
    constructor(props) {
        super(props);
        this.state = {
            focus: false
    ...
    render() {
        ...
        return (h("oj-selector", { class: 'oj-selector' },
            h("span", { class: spanClassName },
...
__decorate([
    listener()
], Selector.prototype, "_handleFocusin", null);
__decorate([
    listener()
], Selector.prototype, "_handleFocusout", null);
__decorate([
    listener()
], Selector.prototype, "_checkboxListener", null);
Selector = __decorate([
