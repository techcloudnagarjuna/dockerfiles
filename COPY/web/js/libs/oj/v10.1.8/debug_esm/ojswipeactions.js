...
import $ from 'jquery';
import { dispatchEvent } from 'ojs/ojdomutils';
  ...
  oj.__registerWidget('oj.ojSwipeActions', $.oj.baseComponent,
    {
      ...
      _SetupResources: function () {
        this._super();
        this._setupOrReleaseOffcanvas(tearDownSwipeActions);
        this._setupOrReleaseOffcanvas(setupSwipeActions);
      },
      ...
      _fireActionEvent: function (ojOption, event) {
        ...
        dispatchEvent(ojOption, new CustomEvent('ojAction', params));
      },
      ...
      _renderAccessibleLink: function (offcanvas) {
        ...
        link.addEventListener('click', function (event) {
          ...
          self._renderOffcanvas(offcanvas, function () {
            ...
            open(offcanvasInfo).then(function () {
      ...
      _doAction: function (action) {
        return new Promise(function (resolve) {
          ...
          if (option != null) {
            ...
            if (offcanvas != null && offcanvas.childElementCount === 0 &&
